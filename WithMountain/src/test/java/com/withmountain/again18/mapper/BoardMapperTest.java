...
public class BoardMapperTest {
	...
	/*
	 * @Test public void testOfSelectBoardListOrderByDate() { try { List<BoardDTO>
	 * boards = boardMapper.selectBoardListOrderByDate(1);
	 * System.out.println(boards.size()); } catch (Exception e) {
	 * e.printStackTrace(); } }
	 */
